...
| [**file-bundle**](https://github.com/chamber-orchestra/file-bundle) | Automatic file upload handling for Doctrine entities — S3 and local filesystem storage, CDN URL generation, configurable upload paths, and event-driven lifecycle management |
...
| [**menu-bundle**](https://github.com/chamber-orchestra/menu-bundle) | Fluent menu and navigation builder — route-based active-item detection, role-based access control, dynamic badges, PSR-6 caching, and Twig rendering with nested tree support |
...
| [**meta**](https://github.com/chamber-orchestra/meta) | SEO metadata trait for Doctrine entities — meta title, description, keywords, Open Graph image, and robots directives (`index`/`noindex`) stored as entity columns with template-ready output |
